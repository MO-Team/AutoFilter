...
namespace AutoFilter.Tests.NHibernate
{
    ...
    public abstract class BaseNHibernateTest
    {
        ...
        /// </summary>
        protected static NHConfiguration NHibernateConfiguration { get; set; }
        ...
        /// </summary>
        protected virtual NHConfiguration GetNHibernateConfiguration()
        {
        ...
        protected virtual void AddCustomConfiguration(NHConfiguration configuration)
        {
        }
